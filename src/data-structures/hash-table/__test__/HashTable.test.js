...
describe('HashTable', () => {
  test('should create hash table of certain size', () => {
    const defaultHashTabel = new HashTable();
    expect(defaultHashTabel.buckets.length).toBe(32);

    const biggerHashTabel = new HashTable(64);
    expect(biggerHashTabel.buckets.length).toBe(64);
  });
